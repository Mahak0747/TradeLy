...
exports.instanceOfEndpointEnum = instanceOfEndpointEnum;
exports.EndpointEnumFromJSON = EndpointEnumFromJSON;
exports.EndpointEnumFromJSONTyped = EndpointEnumFromJSONTyped;
exports.EndpointEnumToJSON = EndpointEnumToJSON;
exports.EndpointEnumToJSONTyped = EndpointEnumToJSONTyped;
/**
 *
 * @export
 */
...
function instanceOfEndpointEnum(value) {
    for (const key in exports.EndpointEnum) {
        if (Object.prototype.hasOwnProperty.call(exports.EndpointEnum, key)) {
            if (exports.EndpointEnum[key] === value) {
                return true;
            }
        }
    }
...
function EndpointEnumFromJSON(json) {
    return EndpointEnumFromJSONTyped(json, false);
}
function EndpointEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
function EndpointEnumToJSON(value) {
    return value;
}
function EndpointEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
