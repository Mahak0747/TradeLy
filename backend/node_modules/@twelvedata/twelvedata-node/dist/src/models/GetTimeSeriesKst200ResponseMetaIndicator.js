...
exports.instanceOfGetTimeSeriesKst200ResponseMetaIndicator = instanceOfGetTimeSeriesKst200ResponseMetaIndicator;
exports.GetTimeSeriesKst200ResponseMetaIndicatorFromJSON = GetTimeSeriesKst200ResponseMetaIndicatorFromJSON;
exports.GetTimeSeriesKst200ResponseMetaIndicatorFromJSONTyped = GetTimeSeriesKst200ResponseMetaIndicatorFromJSONTyped;
exports.GetTimeSeriesKst200ResponseMetaIndicatorToJSON = GetTimeSeriesKst200ResponseMetaIndicatorToJSON;
exports.GetTimeSeriesKst200ResponseMetaIndicatorToJSONTyped = GetTimeSeriesKst200ResponseMetaIndicatorToJSONTyped;
/**
 * Check if a given object implements the GetTimeSeriesKst200ResponseMetaIndicator interface.
 */
function instanceOfGetTimeSeriesKst200ResponseMetaIndicator(value) {
...
function GetTimeSeriesKst200ResponseMetaIndicatorFromJSON(json) {
    return GetTimeSeriesKst200ResponseMetaIndicatorFromJSONTyped(json, false);
}
function GetTimeSeriesKst200ResponseMetaIndicatorFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function GetTimeSeriesKst200ResponseMetaIndicatorToJSON(json) {
    return GetTimeSeriesKst200ResponseMetaIndicatorToJSONTyped(json, false);
}
function GetTimeSeriesKst200ResponseMetaIndicatorToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
