 ...
 */
export function instanceOfTimeSeriesItem(value) {
...
export function TimeSeriesItemFromJSON(json) {
    return TimeSeriesItemFromJSONTyped(json, false);
}
export function TimeSeriesItemFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TimeSeriesItemToJSON(json) {
    return TimeSeriesItemToJSONTyped(json, false);
}
export function TimeSeriesItemToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
