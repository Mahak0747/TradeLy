 ...
 */
export function instanceOfGetTimeSeriesMacd200ResponseMetaIndicator(value) {
...
export function GetTimeSeriesMacd200ResponseMetaIndicatorFromJSON(json) {
    return GetTimeSeriesMacd200ResponseMetaIndicatorFromJSONTyped(json, false);
}
export function GetTimeSeriesMacd200ResponseMetaIndicatorFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function GetTimeSeriesMacd200ResponseMetaIndicatorToJSON(json) {
    return GetTimeSeriesMacd200ResponseMetaIndicatorToJSONTyped(json, false);
}
export function GetTimeSeriesMacd200ResponseMetaIndicatorToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
