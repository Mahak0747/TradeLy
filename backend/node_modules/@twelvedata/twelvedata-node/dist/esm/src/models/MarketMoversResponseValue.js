 ...
 */
export function instanceOfMarketMoversResponseValue(value) {
...
export function MarketMoversResponseValueFromJSON(json) {
    return MarketMoversResponseValueFromJSONTyped(json, false);
}
export function MarketMoversResponseValueFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function MarketMoversResponseValueToJSON(json) {
    return MarketMoversResponseValueToJSONTyped(json, false);
}
export function MarketMoversResponseValueToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
