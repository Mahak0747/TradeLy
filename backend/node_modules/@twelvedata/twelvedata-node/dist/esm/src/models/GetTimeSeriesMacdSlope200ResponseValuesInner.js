 ...
 */
export function instanceOfGetTimeSeriesMacdSlope200ResponseValuesInner(value) {
    if (!("datetime" in value) || value["datetime"] === undefined)
        return false;
    if (!("macdSlope" in value) || value["macdSlope"] === undefined)
        return false;
...
export function GetTimeSeriesMacdSlope200ResponseValuesInnerFromJSON(json) {
    return GetTimeSeriesMacdSlope200ResponseValuesInnerFromJSONTyped(json, false);
}
export function GetTimeSeriesMacdSlope200ResponseValuesInnerFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function GetTimeSeriesMacdSlope200ResponseValuesInnerToJSON(json) {
    return GetTimeSeriesMacdSlope200ResponseValuesInnerToJSONTyped(json, false);
}
export function GetTimeSeriesMacdSlope200ResponseValuesInnerToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
