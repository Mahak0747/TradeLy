...
export function instanceOfTypeEnum(value) {
...
export function TypeEnumFromJSON(json) {
    return TypeEnumFromJSONTyped(json, false);
}
export function TypeEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function TypeEnumToJSON(value) {
    return value;
}
export function TypeEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
