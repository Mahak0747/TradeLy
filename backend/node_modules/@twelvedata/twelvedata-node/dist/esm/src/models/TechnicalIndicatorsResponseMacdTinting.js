 ...
 */
export function instanceOfTechnicalIndicatorsResponseMacdTinting(value) {
    return true;
}
export function TechnicalIndicatorsResponseMacdTintingFromJSON(json) {
    return TechnicalIndicatorsResponseMacdTintingFromJSONTyped(json, false);
}
export function TechnicalIndicatorsResponseMacdTintingFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function TechnicalIndicatorsResponseMacdTintingToJSON(json) {
    return TechnicalIndicatorsResponseMacdTintingToJSONTyped(json, false);
}
export function TechnicalIndicatorsResponseMacdTintingToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
