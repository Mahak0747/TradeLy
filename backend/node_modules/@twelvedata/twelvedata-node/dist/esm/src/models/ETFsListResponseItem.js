 ...
 */
export function instanceOfETFsListResponseItem(value) {
...
export function ETFsListResponseItemFromJSON(json) {
    return ETFsListResponseItemFromJSONTyped(json, false);
}
export function ETFsListResponseItemFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ETFsListResponseItemToJSON(json) {
    return ETFsListResponseItemToJSONTyped(json, false);
}
export function ETFsListResponseItemToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
