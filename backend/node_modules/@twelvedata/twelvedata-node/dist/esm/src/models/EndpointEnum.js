...
export function EndpointEnumFromJSON(json) {
    return EndpointEnumFromJSONTyped(json, false);
}
export function EndpointEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function EndpointEnumToJSON(value) {
    return value;
}
export function EndpointEnumToJSONTyped(value, ignoreDiscriminator) {
    return value;
}
