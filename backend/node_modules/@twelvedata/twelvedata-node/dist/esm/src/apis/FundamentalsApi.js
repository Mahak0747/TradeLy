...
import { DividendsCalendarItemFromJSON, GetBalanceSheet200ResponseFromJSON, GetBalanceSheetConsolidated200ResponseFromJSON, GetCashFlow200ResponseFromJSON, GetCashFlowConsolidated200ResponseFromJSON, GetDividends200ResponseFromJSON, GetEarnings200ResponseFromJSON, GetEarningsCalendar200ResponseFromJSON, GetIncomeStatement200ResponseFromJSON, GetIncomeStatementConsolidated200ResponseFromJSON, GetKeyExecutives200ResponseFromJSON, GetLastChanges200ResponseFromJSON, GetLogo200ResponseFromJSON, GetMarketCap200ResponseFromJSON, GetProfile200ResponseFromJSON, GetSplits200ResponseFromJSON, GetStatistics200ResponseFromJSON, PressReleasesListParameters200ResponseFromJSON, SplitsCalendarResponseItemFromJSON, } from "../models/index";
/**
 *
 */
export class FundamentalsApi extends runtime.BaseAPI {
     ...
     * Balance sheet
     */
    getBalanceSheetRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetBalanceSheet200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The balance sheet endpoint provides a detailed financial statement for a company, outlining its assets, liabilities, and shareholders\' equity. This endpoint returns structured data that includes current and non-current assets, total liabilities, and equity figures, enabling users to assess a company\'s financial health and stability.
    ...
    getBalanceSheet() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getBalanceSheetRaw(requestParameters, initOverrides);
     ...
     */
    getBalanceSheetConsolidatedRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetBalanceSheetConsolidated200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The balance sheet consolidated endpoint provides a detailed overview of a company\'s raw balance sheet, including a comprehensive summary of its assets, liabilities, and shareholders\' equity. This endpoint is useful for retrieving financial data that reflects the overall financial position of a company, allowing users to access critical information about its financial health and structure.
    ...
    getBalanceSheetConsolidated() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getBalanceSheetConsolidatedRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Cash flow
     */
    getCashFlowRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetCashFlow200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The cash flow endpoint provides detailed information on a company\'s cash flow activities, including the net cash and cash equivalents moving in and out of the business. This data includes operating, investing, and financing cash flows, offering a comprehensive view of the company\'s liquidity and financial health.
    ...
    getCashFlow() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getCashFlowRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getCashFlowConsolidatedRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetCashFlowConsolidated200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The cash flow consolidated endpoint provides raw data on a company\'s consolidated cash flow, including the net cash and cash equivalents moving in and out of the business. It returns information on operating, investing, and financing activities, helping users track liquidity and financial health over a specified period.
    ...
    getCashFlowConsolidated() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getCashFlowConsolidatedRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Dividends
     */
    getDividendsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetDividends200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The dividends endpoint provides historical dividend data for a specified stock, in many cases covering over a decade. It returns information on dividend payouts, including the ex-date, amount, and frequency. This endpoint is ideal for users tracking dividend histories or evaluating the income potential of stocks.
    ...
    getDividends() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getDividendsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Dividends calendar
     */
    getDividendsCalendarRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(DividendsCalendarItemFromJSON));
        });
    }
    /**
     * The dividends calendar endpoint provides a detailed schedule of upcoming and past dividend events for specified date ranges. By using the `start_date` and `end_date` parameters, users can retrieve a list of companies issuing dividends, including the ex-dividend date and dividend amount. This endpoint is ideal for tracking dividend payouts and planning investment strategies based on dividend schedules.
    ...
    getDividendsCalendar() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getDividendsCalendarRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Earnings
     */
    getEarningsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetEarnings200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The earnings endpoint provides comprehensive earnings data for a specified company, including both the estimated and actual Earnings Per Share (EPS) figures. This endpoint delivers historical earnings information, allowing users to track a company\'s financial performance over time.
    ...
    getEarnings() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getEarningsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Earnings calendar
     */
    getEarningsCalendarRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["exchange"] != null) {
                queryParameters["exchange"] = requestParameters["exchange"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetEarningsCalendar200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The earnings calendar endpoint provides a schedule of company earnings announcements for a specified date range. By default, it returns earnings data for the current day. Users can customize the date range using the `start_date` and `end_date` parameters to retrieve earnings information for specific periods. This endpoint is useful for tracking upcoming earnings reports and planning around key financial announcements.
    ...
    getEarningsCalendar() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getEarningsCalendarRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Income statement
     */
    getIncomeStatementRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetIncomeStatement200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The income statement endpoint provides detailed financial data on a company\'s income statement, including revenues, expenses, and net income for specified periods, either annually or quarterly. This endpoint is essential for retrieving comprehensive financial performance metrics of a company, allowing users to access historical and current financial results.
    ...
    getIncomeStatement() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getIncomeStatementRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getIncomeStatementConsolidatedRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetIncomeStatementConsolidated200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The income statement consolidated endpoint provides a company\'s raw income statement, detailing revenue, expenses, and net income for specified periods, either annually or quarterly. This data is essential for evaluating a company\'s financial performance over time, allowing users to access comprehensive financial results in a structured format.
    ...
    getIncomeStatementConsolidated() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getIncomeStatementConsolidatedRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * IPO calendar
     */
    getIpoCalendarRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["exchange"] != null) {
                queryParameters["exchange"] = requestParameters["exchange"];
    ...
    getIpoCalendar() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getIpoCalendarRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Key executives
     */
    getKeyExecutivesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetKeyExecutives200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The key executives endpoint provides detailed information about a company\'s key executives identified by a specific stock symbol. It returns data such as names, titles, and roles of the executives, which can be useful for understanding the leadership structure of the company.
    ...
    getKeyExecutives() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getKeyExecutivesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Last changes
     */
    getLastChangesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters["endpoint"] == null) {
                throw new runtime.RequiredError("endpoint", 'Required parameter "endpoint" was null or undefined when calling getLastChanges().');
            }
            const queryParameters = {};
            if (requestParameters["startDate"] != null) {
                queryParameters["start_date"] = requestParameters["startDate"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetLastChanges200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The last change endpoint provides the most recent updates to fundamental data for a specified dataset. It returns a timestamp indicating when the data was last modified, allowing users to efficiently manage API requests by only fetching new data when changes occur. This helps optimize data retrieval and reduce unnecessary API credit usage.
     * Last changes
     */
    getLastChanges(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getLastChangesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Logo
     */
    getLogoRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters["symbol"] == null) {
                throw new runtime.RequiredError("symbol", 'Required parameter "symbol" was null or undefined when calling getLogo().');
            }
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetLogo200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The logo endpoint provides the official logo image for a specified company, cryptocurrency, or forex pair. This endpoint is useful for integrating visual branding elements into financial applications, websites, or reports, ensuring that users can easily identify and associate the correct logo with the respective financial asset.
     * Logo
     */
    getLogo(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getLogoRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMarketCapRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMarketCap200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The Market Capitalization History endpoint provides historical data on a company\'s market capitalization over a specified time period. It returns a time series of market cap values, allowing users to track changes in a company\'s market value.
    ...
    getMarketCap() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMarketCapRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Splits
     */
    getSplitsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetSplits200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The splits endpoint provides historical data on stock split events for a specified company. It returns details including the date of each split and the corresponding split factor.
    ...
    getSplits() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getSplitsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Splits calendar
     */
    getSplitsCalendarRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(SplitsCalendarResponseItemFromJSON));
        });
    }
    /**
     * The splits calendar endpoint provides a detailed calendar of stock split events within a specified date range. By setting the `start_date` and `end_date` parameters, users can retrieve a list of upcoming or past stock splits, including the company name, split ratio, and effective date. This endpoint is useful for tracking changes in stock structure and planning investment strategies around these events.
    ...
    getSplitsCalendar() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getSplitsCalendarRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Statistics
     */
    getStatisticsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
    ...
    getStatistics() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getStatisticsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Press releases
     */
    pressReleasesListParametersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => PressReleasesListParameters200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The press releases endpoint offers structured, real-time access to official company press releases and corporate announcements from public entities across global markets.
    ...
    pressReleasesListParameters() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.pressReleasesListParametersRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
