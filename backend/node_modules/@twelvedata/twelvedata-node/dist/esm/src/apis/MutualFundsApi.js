...
import { GetMutualFundsFamily200ResponseFromJSON, GetMutualFundsList200ResponseFromJSON, GetMutualFundsType200ResponseFromJSON, GetMutualFundsWorld200ResponseFromJSON, GetMutualFundsWorldComposition200ResponseFromJSON, GetMutualFundsWorldPerformance200ResponseFromJSON, GetMutualFundsWorldPurchaseInfo200ResponseFromJSON, GetMutualFundsWorldRatings200ResponseFromJSON, GetMutualFundsWorldRisk200ResponseFromJSON, GetMutualFundsWorldSummary200ResponseFromJSON, GetMutualFundsWorldSustainability200ResponseFromJSON, } from "../models/index";
/**
 *
 */
export class MutualFundsApi extends runtime.BaseAPI {
     ...
     * MFs families
     */
    getMutualFundsFamilyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsFamily200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds family endpoint provides a comprehensive list of MF families, which are groups of mutual funds managed by the same investment company. This data is useful for users looking to explore or compare different fund families, understand the range of investment options offered by each, and identify potential investment opportunities within specific fund families.
    ...
    getMutualFundsFamily() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsFamilyRaw(requestParameters, initOverrides);
     ...
     * MFs directory
     */
    getMutualFundsListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsList200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds directory endpoint provides a daily updated list of mutual funds, sorted in descending order by their total assets value. This endpoint is useful for retrieving an organized overview of available mutual funds.
    ...
    getMutualFundsList() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsListRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * MFs types
     */
    getMutualFundsTypeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["fundType"] != null) {
                queryParameters["fund_type"] = requestParameters["fundType"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsType200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * This endpoint provides detailed information on various types of mutual funds, such as equity, bond, and balanced funds, allowing users to understand the different investment options available.
    ...
    getMutualFundsType() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsTypeRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * MF full data
     */
    getMutualFundsWorldRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorld200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual full data endpoint provides detailed information about global mutual funds. It returns a comprehensive dataset that includes a summary of the fund, its performance metrics, risk assessment, ratings, asset composition, purchase details, and sustainability factors. This endpoint is essential for users seeking in-depth insights into mutual funds on a global scale, allowing them to evaluate various aspects such as investment performance, risk levels, and environmental impact.
    ...
    getMutualFundsWorld() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Composition
     */
    getMutualFundsWorldCompositionRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorldComposition200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds compositions endpoint provides detailed information about the portfolio composition of a specified mutual fund. It returns data on sector allocations, individual holdings, and their respective weighted exposures. This endpoint is useful for users seeking to understand the investment distribution and risk profile of a mutual fund.
    ...
    getMutualFundsWorldComposition() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldCompositionRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Performance
     */
    getMutualFundsWorldPerformanceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorldPerformance200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds performances endpoint provides comprehensive performance data for mutual funds globally. It returns metrics such as trailing returns, annual returns, quarterly returns, and load-adjusted returns.
    ...
    getMutualFundsWorldPerformance() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldPerformanceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Purchase info
     */
    getMutualFundsWorldPurchaseInfoRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorldPurchaseInfo200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds purchase information endpoint provides detailed purchasing details for global mutual funds. It returns data on minimum investment requirements, current pricing, and a list of brokerages where the mutual fund can be purchased. This endpoint is useful for users looking to understand the entry requirements and options available for investing in specific mutual funds.
    ...
    getMutualFundsWorldPurchaseInfo() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldPurchaseInfoRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Ratings
     */
    getMutualFundsWorldRatingsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorldRatings200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds ratings endpoint provides detailed ratings for mutual funds across global markets. It returns data on the performance and quality of mutual funds, including ratings calculated in-house by Twelve Data and from various financial institutions.
    ...
    getMutualFundsWorldRatings() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldRatingsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Risk
     */
    getMutualFundsWorldRiskRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorldRisk200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds risk endpoint provides detailed risk metrics for global mutual funds. It returns data such as standard deviation, beta, and Sharpe ratio, which help assess the volatility and risk profile of mutual funds across different markets.
    ...
    getMutualFundsWorldRisk() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldRiskRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Summary
     */
    getMutualFundsWorldSummaryRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorldSummary200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds summary endpoint provides a concise overview of global mutual funds, including key details such as fund name, symbol, asset class, and region. This endpoint is useful for quickly obtaining essential information about various mutual funds worldwide, aiding in the comparison and selection of funds for investment portfolios.
    ...
    getMutualFundsWorldSummary() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldSummaryRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Sustainability
     */
    getMutualFundsWorldSustainabilityRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters["symbol"] != null) {
                queryParameters["symbol"] = requestParameters["symbol"];
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => GetMutualFundsWorldSustainability200ResponseFromJSON(jsonValue));
        });
    }
    /**
     * The mutual funds sustainability endpoint provides detailed information on the sustainability and Environmental, Social, and Governance (ESG) ratings of global mutual funds. It returns data such as ESG scores, sustainability metrics, and fund identifiers.
    ...
    getMutualFundsWorldSustainability() {
        return __awaiter(this, arguments, void 0, function* (requestParameters = {}, initOverrides) {
            const response = yield this.getMutualFundsWorldSustainabilityRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
